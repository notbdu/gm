...
import (
	...
	gmmodule "github.com/notbdu/gm/x/gm"
	gmmodulekeeper "github.com/notbdu/gm/x/gm/keeper"
	gmmoduletypes "github.com/notbdu/gm/x/gm/types"
	// this line is used by starport scaffolding # stargate/app/moduleImport

	appparams "github.com/notbdu/gm/app/params"
	"github.com/notbdu/gm/docs"
)
...
func New(
	...
	*/
	...
	app.GmKeeper = *gmmodulekeeper.NewKeeper(
		appCodec,
		keys[gmmoduletypes.StoreKey],
		keys[gmmoduletypes.MemStoreKey],
		app.GetSubspace(gmmoduletypes.ModuleName),
	)
	gmModule := gmmodule.NewAppModule(appCodec, app.GmKeeper, app.AccountKeeper, app.BankKeeper)
